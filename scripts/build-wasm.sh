...
if [ -z "$EXAMPLES" ]; then
  EXAMPLES=" triangle vertexattributes particlesystem texture texturecubemap texturearray textoverlay textmesh gltf gltfskinning pipelines gears stencilbuffer"
fi
