...
if [ -z "$EXAMPLES" ]; then
  EXAMPLES=" triangle vertexattributes particlesystem texture texturemipmapgen texturecubemap texturearray textoverlay textmesh gltf gltfskinning instancing indirectdraw pipelines gears stencilbuffer occlusionquery radialblur bloom shadowmapping shadowmappingcascade shadowmappingomni"
fi
