...
if [ -z "$EXAMPLES" ]; then
  EXAMPLES=" triangle vertexattributes particlesystem texture texturecubemap texturearray textoverlay textmesh gltf gltfskinning instancing pipelines gears stencilbuffer"
fi
