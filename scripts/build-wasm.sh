...
if [ -z "$EXAMPLES" ]; then
  EXAMPLES=" triangle vertexattributes particlesystem texture texturemipmapgen texturecubemap texturearray textoverlay textmesh gltf gltfskinning instancing indirectdraw pipelines gears stencilbuffer occlusionquery radialblur bloom deferred parallaxmapping multisampling multisamplingalphatocoverage pbr pbribl pbrtexture shadowmapping shadowmappingcascade shadowmappingomni"
fi
