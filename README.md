...
| `nanite` | Streams GPU-requested Jax geometry pages into a physical cache, selects projected-error meshlet LODs, performs two-pass HZB occlusion with current-frame recovery, and submits static and skinned populations through indirect draws. | <picture><source srcset="screenshots/nanite.webp" type="image/webp"><img src="screenshots/nanite.jpg" alt="Nanite-style Jax meshlet rendering"></picture> |
